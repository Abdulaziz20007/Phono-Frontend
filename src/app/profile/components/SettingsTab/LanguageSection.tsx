  ...
  return (
    <SectionCard>
      ...
      <SectionContent $isOpen={isOpen}>
        {/* <<<--- $isOpen transient prop bilan chaqirish */}
        <LanguageOptionsContainer>
          {languages.map((lang) => {
            const isChecked = currentLanguage === lang.code;
            // console.log(`LanguageSection: Rendering radio for ${lang.name}. Checked: ${isChecked} (current: ${currentLanguage}, lang.code: ${lang.code})`); // DEBUG 9 - juda ko'p log berishi mumkin
            return (
